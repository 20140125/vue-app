        ...
        data () {
            return {
                value: '```JavaScript\n' +
                    ...
                    '                let config = {headers: {"Content-Type": "multipart/form-data","Authorization":`${func.setPassword(func.setRandom(32), func.setRandom(12))}${this.token}${func.setPassword(func.setRandom(32), func.setRandom(12))}`}}\n' +
