<template>
  <div id="system">
    <el-dialog v-model="visible" :title="reForm === 'created' ? '添加系统配置' : '修改系统'" :show-close="false"
      ...
      <el-form :model="localForm" :ref="reForm" label-position="left" label-width="100px" :rules="rules">
            ...
            <div class="el-form-item is-required children">
              ...
              <div class="el-form-item__content">
                ...
                <div class="el-form-item">
                  ...
                  <div class="el-form-item__content">
                    <el-input placeholder="请输入对应的VALUE，用逗号间隔" type="textarea" resize="none" :autosize="{ minRows: 4}"
                ...
                <div class="el-form-item">
                  ...
                  <div class="el-form-item__content">
                    <el-switch v-model.number="item.status" active-color="#13ce66" inactive-color="#ff4949"
                ...
                <div class="el-form-item">
                  ...
                  <div class="el-form-item__content">
                    <el-button v-if="localForm.children.length > 1" type="danger" size="mini" plain
                               icon="el-icon-delete" @click="deleteChildren(localForm.children, index)">移除
                    </el-button>
                  </div>
                </div>
              </div>
        ...
        <el-button type="primary" plain size="mini" icon="el-icon-plus" @click="addChildren(localForm.children)">新增
        </el-button>
