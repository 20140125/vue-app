<template>
    <el-table :data="areaLists" row-key="id" :tree-props="{children: '__child', hasChildren: 'hasChildren'}" lazy :load="loadMORE">
        ...
        <el-table-column align="right">
            ...
            <template #default="scope">
                <el-button type="primary" icon="el-icon-search" plain size="mini" @click="$emit('getAreaWeather', scope.row)">查看天气</el-button>
            </template>
        </el-table-column>
    </el-table>
</template>
