<template>
  <el-table :data="pushLists">
    ...
    <el-table-column align="center" label="推送标题" width="200px">
    ...
    <el-table-column align="center" label="实时推送" width="100px">
      <template #default="scope">
    ...
    <el-table-column align="center" label="推送状态" width="150px">
      <template #default="scope">
