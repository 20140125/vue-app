<template>
  <div v-loading="loading" :element-loading-text="loadingText">
    ...
    <el-dialog :title="title" :width="dialogWidth" :visible.sync="syncVisible" :modal="true"  :center="true">
      <el-form :ref="reFrom" :label-width="labelWidth" :model="userModel" :rules="rules" label-position="left">
    ...
    export default {
        ...
        methods: {
            ...
            addUser: function () {
                ...
                this.reFrom = 'created'
                this.userModel = {username: '', email: '', password: '', salt: func.setRandom(), status: 1, role_id: 2, phone_number: '', created_at: func.getTimestamp(), updated_at: func.getTimestamp(), remember_token: ''}
