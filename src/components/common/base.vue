...
<!--                        <img src="https://www.fanglonger.com/image/logo.jpg" class="layui-nav-img" alt=""> -->
                        {{username}}
                    </a>
                    <dl class="layui-nav-child">
                        <dd><a href="">基本资料</a></dd>
        ...
        <div class="layui-side layui-bg-black" id="left_box_admin">
            <el-menu background-color="#393D49" text-color="#fff" unique-opened :collapse="isCollapse">
                <el-submenu v-for="(menu,index) in menuLists" :key="index" :index="menu.id.toString()">
                    ...
                    <el-menu-item :index="child.id.toString()"  v-for="(child,index) in menu.__children" @click="setAttr(child)" :key="index" style="width: 190px" >
